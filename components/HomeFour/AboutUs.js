          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="about-content">
                ...
                security management services, as it employed the best talents 
                in the field of technology to provide innovative cyber security
                 services by benefiting from leading expertise in the field of 
